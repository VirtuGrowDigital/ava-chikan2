  ...
  return (
    <section className="max_padd_container flexCenter flex-col pt-52">
      <div className="max-w-[555px] h-[600px] bg-white m-auto px-14 py-10 ">
        <h3 className="text-[32px] leading-tight md:text-[36px] md:leading-[1.3] mb-4 font-semibold">Sign Up</h3>
        ...
        <p className="text-black font-bold">Already have a account?<span className="
